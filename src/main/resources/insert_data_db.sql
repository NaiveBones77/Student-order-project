insert into jc_street(street_code, street_name) VALUES (1, 'Улица Садовая'),
                                                       (2, 'Нечаевский проспект'),
                                                       (3, 'Улица Советская'),
                                                       (4, 'Проспект Вернандского'),
                                                       (5, 'Улица Волкова');

insert into jc_university(university_id, university_name) values (1, 'МГУ'),
                                                                       (2, 'МАИ'),
                                                                       (3, 'РЭУ Плеханова');
